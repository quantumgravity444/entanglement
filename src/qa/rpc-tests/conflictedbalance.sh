...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars ENTANGLEMENTD and ENTANGLEMENTCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

ENTANGLEMENTD=${ENTANGLEMENTD:-${1}/entanglementd}
CLI=${SEQUENCECLI:-${1}/entanglement-cli}
