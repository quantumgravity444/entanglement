...
class TxnMallTest(entanglementTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ENTANGLEMENT:
        ...
        # First: use raw transaction API to send 1210 ENTANGLEMENT to node1_address,
        # but don't broadcast:
