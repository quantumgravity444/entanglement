...
###   This script attempts to download the signature file SHA256SUMS.asc from entanglement.org
...
WORKINGDIR="/tmp/entanglement"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://entanglement.io/bin/0.1.0.0/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://entanglement.io/bin/"
VERSIONPREFIX="entanglement-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'entanglement-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[entanglement-]<version>-[rc[0-9]] (example: entanglement-0.1.0-rc1)"
   echo "wget output:"
