...
#ifndef ENTANGLEMENT_SCRIPT_SCRIPT_H
#define ENTANGLEMENT_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, entanglement always counted CHECKMULTISIGs
...
#endif // ENTANGLEMENT_SCRIPT_SCRIPT_H
