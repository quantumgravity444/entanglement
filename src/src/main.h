...
#ifndef ENTANGLEMENT_MAIN_H
#define ENTANGLEMENT_MAIN_H
...
static const CAmount STATIC_POW_REWARD = 9.80665 * COIN;
static const CAmount STATIC_POS_REWARD = 6.67408 * COIN;
...
// Entanglement: reward for blocks
