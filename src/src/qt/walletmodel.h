...
#ifndef ENTANGLEMENT_QT_WALLETMODEL_H
#define ENTANGLEMENT_QT_WALLETMODEL_H
...
/** Interface to entanglement wallet from Qt view code. */
...
public:
    ...
    bool isMine(const CEntanglementAddress &address);
...
#endif // ENTANGLEMENT_QT_WALLETMODEL_H
