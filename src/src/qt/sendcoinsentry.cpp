    ...
    model(0)
{
    ...
    // normal Entanglement address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying Entanglement address(es)
    ...
    ui->payTo->setValidator(0);  // Entanglement: disable validator so that we can type names
}
