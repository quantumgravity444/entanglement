...
#ifndef ENTANGLEMENT_QT_ENTANGLEMENTUNITS_H
#define ENTANGLEMENT_QT_ENTANGLEMENTUNITS_H
...
/** entanglement unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EntanglementUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EntanglementUnits(QObject *parent);

    /** Entanglement units.
      @note Source: https://en.entanglement.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ETG,
...
typedef EntanglementUnits::Unit SequenceUnit;

#endif // ENTANGLEMENT_QT_ENTANGLEMENTUNITS_H