...
#include "config/entanglement-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + EntanglementUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatsequenceURI(info));
}
