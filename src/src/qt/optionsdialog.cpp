    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ENTANGLEMENT-silver"), QVariant("silver"));
    ...
    ui->unit->setModel(new EntanglementUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->sequenceAtStartup, OptionsModel::StartAtStartup);
