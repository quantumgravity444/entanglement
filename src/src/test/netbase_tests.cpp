...
{
    BOOST_CHECK(TestSplitHost("www.entanglement.org", "www.entanglement.org", -1));
    BOOST_CHECK(TestSplitHost("[www.entanglement.org]", "www.entanglement.org", -1));
    BOOST_CHECK(TestSplitHost("www.entanglement.org:80", "www.entanglement.org", 80));
    BOOST_CHECK(TestSplitHost("[www.entanglement.org]:80", "www.entanglement.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:51000", "127.0.0.1", 51000));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:51000", "127.0.0.1", 51000));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:51000", "::ffff:127.0.0.1", 51000));
    BOOST_CHECK(TestSplitHost("[::]:51000", "::", 51000));
    BOOST_CHECK(TestSplitHost("::51000", "::51000", -1));
    BOOST_CHECK(TestSplitHost(":51000", "", 51000));
    BOOST_CHECK(TestSplitHost("[]:51000", "", 51000));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:51000", "127.0.0.1:51000"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:51000", "[::]:51000"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
