...
#ifndef ENTANGLEMENT_UINT256_H
#define ENTANGLEMENT_UINT256_H
...
public:
     ...
     * 
     * entanglement only uses this "compact" format for encoding difficulty
