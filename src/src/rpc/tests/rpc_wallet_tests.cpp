...
// Copyright (c) 2017 Entanglement Developers developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CEntanglementAddress demoAddress = CEntanglementAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CEntanglementAddress setaccountDemoAddress = CEntanglementAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CEntanglementAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CEntanglementAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
