...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Entanglement server stopping";
}
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use entanglementd, or the -server option to entanglement-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
{
    return "> entanglement-cli " + methodname + " " + args + "\n";
}
