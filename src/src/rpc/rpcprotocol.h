...
#ifndef ENTANGLEMENT_RPCPROTOCOL_H
#define ENTANGLEMENT_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! entanglement is not connected
...
#endif // ENTANGLEMENT_RPCPROTOCOL_H
