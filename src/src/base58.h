 ...
 */
#ifndef ENTANGLEMENT_BASE58_H
#define ENTANGLEMENT_BASE58_H
...
/**
 * Encode a byte entanglement as a base58-encoded string.
...
/** base58-encoded Entanglement addresses.
 * Public-key-hash-addresses have version 0 (or 111 testnet).
 * The data vector contains RIPEMD160(SHA256(pubkey)), where pubkey is the serialized public key.
 * Script-hash-addresses have version 5 (or 196 testnet).
 * The data vector contains RIPEMD160(SHA256(cscript)), where cscript is the serialized redemption script.
 */
class CEntanglementAddress : public CBase58Data {
public:
    ...
    CEntanglementAddress() {}
    CEntanglementAddress(const CTxDestination &dest) { Set(dest); }
    CEntanglementAddress(const std::string& strAddress) { SetString(strAddress); }
    CEntanglementAddress(const char* pszAddress) { SetString(pszAddress); }
