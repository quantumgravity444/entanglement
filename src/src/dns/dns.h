...
static const unsigned int NAME_REGISTRATION_DAILY_FEE = 1000000; // Current set to 0.3 ETG per month or 3.65 ETG per year.
...
bool GetNameCurrentAddress(const CNameVal& name, CEntanglementAddress& address, std::string& error);
